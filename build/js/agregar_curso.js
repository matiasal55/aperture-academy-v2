...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/fetch */ \"./src/js/components/fetch.js\");\n/* harmony import */ var _components_contadorCarrito__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/contadorCarrito */ \"./src/js/components/contadorCarrito.js\");\n/* harmony import */ var _components_menuResponsive__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/menuResponsive */ \"./src/js/components/menuResponsive.js\");\n/* harmony import */ var _components_enviar_datos__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/enviar_datos */ \"./src/js/components/enviar_datos.js\");\n/* harmony import */ var _components_links_db__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/links_db */ \"./src/js/components/links_db.js\");\n/* harmony import */ var _components_cargar_profesor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/cargar_profesor */ \"./src/js/components/cargar_profesor.js\");\nfunction _construct(Parent, args, Class) { if (_isNativeReflectConstruct()) { _construct = Reflect.construct; } else { _construct = function _construct(Parent, args, Class) { var a = [null]; a.push.apply(a, args); var Constructor = Function.bind.apply(Parent, a); var instance = new Constructor(); if (Class) _setPrototypeOf(instance, Class.prototype); return instance; }; } return _construct.apply(null, arguments); }\n\nfunction _isNativeReflectConstruct() { if (typeof Reflect === \"undefined\" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === \"function\") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === \"undefined\" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n\n\n\n\n\n\n\nvar Curso = function Curso(titulo, detalles, precio, horas, requisitos, profesor) {\n  _classCallCheck(this, Curso);\n\n  this.id = titulos_cursos.length + 1;\n  this.titulo = titulo;\n  this.detalles = detalles;\n  this.precio = precio;\n  this.horas = horas;\n  this.requisitos = requisitos;\n  this.contenidos = [];\n  this.profesor = profesor;\n};\n\nvar formulario = document.getElementById(\"form\");\nvar enviar = document.getElementById(\"enviar\");\nvar profesores = document.getElementById(\"profesor\");\nvar botonTematica = document.getElementsByClassName(\"boton-tematica\");\nvar botonBorrar = document.getElementsByClassName(\"boton-borrar\");\nvar agregarUnidad = document.getElementById(\"boton-contenido\"); // formulario.reset();\n\nvar titulos_cursos = []; // Extrae los nombres de los cursos\n\nvar enlistar_cursos = function enlistar_cursos(dato) {\n  var _iterator = _createForOfIteratorHelper(dato),\n      _step;\n\n  try {\n    for (_iterator.s(); !(_step = _iterator.n()).done;) {\n      var curso = _step.value;\n      titulos_cursos.push(curso.titulo);\n    }\n  } catch (err) {\n    _iterator.e(err);\n  } finally {\n    _iterator.f();\n  }\n};\n\nObject(_components_fetch__WEBPACK_IMPORTED_MODULE_0__[\"extraerDatos\"])(_components_links_db__WEBPACK_IMPORTED_MODULE_4__[\"json_cursos\"], enlistar_cursos); // Inserta los nombres de los profesores en el select de manera ordenada\n\nvar insertarProfesores = function insertarProfesores(lista) {\n  var _iterator2 = _createForOfIteratorHelper(lista),\n      _step2;\n\n  try {\n    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {\n      var profesor = _step2.value;\n\n      var _opcion = document.createElement(\"option\");\n\n      _opcion.setAttribute(\"name\", \"\".concat(profesor.id));\n\n      _opcion.setAttribute(\"value\", \"\".concat(profesor.nombre));\n\n      _opcion.textContent = \"\".concat(profesor.nombre);\n      profesores.appendChild(_opcion);\n    }\n  } catch (err) {\n    _iterator2.e(err);\n  } finally {\n    _iterator2.f();\n  }\n\n  var ordenar = _toConsumableArray(profesores.children);\n\n  ordenar.shift();\n  ordenar.sort(function (a, b) {\n    return a.value > b.value;\n  }).forEach(function (nodo) {\n    return profesores.appendChild(nodo);\n  });\n  var opcion = document.createElement(\"option\");\n  opcion.textContent = \"Otro\";\n  profesores.appendChild(opcion);\n};\n\nObject(_components_fetch__WEBPACK_IMPORTED_MODULE_0__[\"extraerDatos\"])(_components_links_db__WEBPACK_IMPORTED_MODULE_4__[\"json_profesores\"], insertarProfesores);\nprofesores.addEventListener(\"change\", function () {\n  if (profesores.selectedIndex === profesores.length - 1) {\n    var agregarProfesor = document.createElement(\"div\");\n    agregarProfesor.className = \"nuevoProfesor\";\n    agregarProfesor.innerHTML = \"<div class='curso-campo'><label for='nombre'> Nombre del profesor: <input type='text' class='input-profesor' id='nombre-profesor' placeholder='Ingrese el nombre del profesor'><div class='error'></div></div>\";\n    agregarProfesor.innerHTML += \"<div class='curso-campo'><label for='descripcion'> Descripción: <input type='text' class='input-profesor' id='descripcion-profesor' placeholder='Ingrese la descripción'><div class='error'></div></div>\";\n    agregarProfesor.innerHTML += \"<div class='curso-campo'><label for='estrellas'> Estrellas: <input type='number' class='input-profesor' id='estrellas-profesor' placeholder='Puntaje'><div class='error'></div></div>\";\n    agregarProfesor.innerHTML += \"<input type='button' id='boton-profesor' value='Agregar profesor'>\";\n    profesores.parentElement.appendChild(agregarProfesor);\n    var boton = document.getElementById(\"boton-profesor\");\n\n    var insertarProfesor = function insertarProfesor(nuevo) {\n      console.log(nuevo); // const nuevaOpcion = document.createElement(\"option\");\n      // nuevaOpcion.setAttribute(\"name\", `${nuevo.id}`);\n      // nuevaOpcion.setAttribute(\"value\", `${nuevo.nombre}`);\n      // nuevaOpcion.setAttribute(\"selected\", \"true\");\n      // nuevaOpcion.textContent = `${nuevo.nombre}`;\n      // profesores.appendChild(nuevaOpcion);\n      // agregarProfesor.innerHTML = \"Profesor agregado\";\n    };\n\n    Object(_components_enviar_datos__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(\"profesor\", boton, \"input-profesor\", \"nombre-profesor\", _components_cargar_profesor__WEBPACK_IMPORTED_MODULE_5__[\"cargar_profesor\"], _components_links_db__WEBPACK_IMPORTED_MODULE_4__[\"json_profesores\"], \"nombre\", insertarProfesor);\n  } else if (document.getElementsByClassName(\"nuevoProfesor\")[0] != undefined) document.getElementsByClassName(\"nuevoProfesor\")[0].remove();\n});\n\nvar agregarTematica = function agregarTematica(boton) {\n  boton.addEventListener(\"click\", function () {\n    var tematicas = boton.parentElement.previousElementSibling;\n    var campos = tematicas.firstElementChild.cloneNode(true);\n    campos.children[1].value = \"\";\n    tematicas.appendChild(campos);\n  });\n};\n\nvar borrarUnidad = function borrarUnidad(boton) {\n  boton.addEventListener(\"click\", function () {\n    var unidad = boton.parentElement.parentElement;\n    if (document.getElementsByClassName(\"tematicas\").length > 1) unidad.remove();\n  });\n};\n\nvar _iterator3 = _createForOfIteratorHelper(botonTematica),\n    _step3;\n\ntry {\n  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {\n    var boton = _step3.value;\n    agregarTematica(boton);\n  }\n} catch (err) {\n  _iterator3.e(err);\n} finally {\n  _iterator3.f();\n}\n\nvar _iterator4 = _createForOfIteratorHelper(botonBorrar),\n    _step4;\n\ntry {\n  for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {\n    var _boton = _step4.value;\n    borrarUnidad(_boton);\n  }\n} catch (err) {\n  _iterator4.e(err);\n} finally {\n  _iterator4.f();\n}\n\nvar contenidos = document.getElementsByClassName(\"carga-contenido\")[0];\nvar campos_original = contenidos.firstElementChild.cloneNode(true);\nagregarUnidad.addEventListener(\"click\", function () {\n  var campos_clon = campos_original.cloneNode(true);\n\n  var _iterator5 = _createForOfIteratorHelper(campos_clon.getElementsByTagName(\"input\")),\n      _step5;\n\n  try {\n    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {\n      var campo = _step5.value;\n      if (campo.type != \"button\") campo.value = \"\";else if (campo.name == \"agregar\") agregarTematica(campo);else if (campo.name == \"borrar\") borrarUnidad(campo);\n    }\n  } catch (err) {\n    _iterator5.e(err);\n  } finally {\n    _iterator5.f();\n  }\n\n  contenidos.appendChild(campos_clon);\n});\n\nvar cargar_curso = function cargar_curso(campos, valores) {\n  var campos_unidad = document.getElementsByClassName(\"unidad-titulo\");\n  campos.splice(campos.length - campos_unidad.length);\n\n  var _iterator6 = _createForOfIteratorHelper(campos),\n      _step6;\n\n  try {\n    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {\n      var dato = _step6.value;\n      valores.push(dato.value);\n    }\n  } catch (err) {\n    _iterator6.e(err);\n  } finally {\n    _iterator6.f();\n  }\n\n  var extraer_profesor = function extraer_profesor(datos) {\n    var _iterator7 = _createForOfIteratorHelper(datos),\n        _step7;\n\n    try {\n      for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {\n        var dato = _step7.value;\n        var mapa = new Map(Object.entries(dato));\n\n        if (mapa.get(\"nombre\") == profesores.value) {\n          valores.push(dato);\n          break;\n        }\n      }\n    } catch (err) {\n      _iterator7.e(err);\n    } finally {\n      _iterator7.f();\n    }\n  };\n\n  Object(_components_fetch__WEBPACK_IMPORTED_MODULE_0__[\"extraerDatos\"])(_components_links_db__WEBPACK_IMPORTED_MODULE_4__[\"json_profesores\"], extraer_profesor);\n  debugger; // Sin el debugger no capta el objeto Profesor\n\n  var nuevo = _construct(Curso, _toConsumableArray(valores));\n\n  var _iterator8 = _createForOfIteratorHelper(campos_unidad),\n      _step8;\n\n  try {\n    for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {\n      var campo = _step8.value;\n      var campos_tematicas = document.getElementsByClassName(\"unidad-tematica\");\n      var tematicas = [];\n\n      var _iterator9 = _createForOfIteratorHelper(campos_tematicas),\n          _step9;\n\n      try {\n        for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {\n          var tematica = _step9.value;\n          if (tematica.value != \"\") tematicas.push(tematica.value);\n        }\n      } catch (err) {\n        _iterator9.e(err);\n      } finally {\n        _iterator9.f();\n      }\n\n      var unidad = {\n        titulo: campo.value,\n        tematicas: tematicas\n      };\n      nuevo.contenidos.push(unidad);\n    }\n  } catch (err) {\n    _iterator8.e(err);\n  } finally {\n    _iterator8.f();\n  }\n\n  return nuevo;\n};\n\nObject(_components_enviar_datos__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(\"curso\", enviar, \"input\", \"titulo-curso\", cargar_curso, _components_links_db__WEBPACK_IMPORTED_MODULE_4__[\"json_cursos\"], \"titulo\");\n\n//# sourceURL=webpack:///./src/js/agregar_curso.js?");
...
/***/ 0:
/*!*******************************************************!*\
  !*** multi @babel/polyfill ./src/js/agregar_curso.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/js/agregar_curso.js */\"./src/js/agregar_curso.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./src/js/agregar_curso.js?");
